...
abstract class BaseAdapter<T>(private val onClick:(position: Int, item: T) -> Unit,
                                private val onFocus:((position: Int) -> Unit)? = null) : RecyclerView.Adapter<BaseAdapter<T>.MyViewHolder>() {
